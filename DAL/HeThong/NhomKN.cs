...
namespace Com.Gosol.CMS.DAL
{
    public class NhomKN
    {
        ...
        private void SetInsertParms(SqlParameter[] parms, NhomKNInfo info)
        {
            ...
            parms[0].Value = info.SoLuong;
            parms[1].Value = info.TenCQ;
            parms[2].Value = info.LoaiDoiTuongKNID;
            parms[3].Value = info.DiaChiCQ;
            parms[4].Value = info.DaiDienPhapLy;
            parms[5].Value = info.DuocUyQuyen;
        ...
        private void SetUpdateParms(SqlParameter[] parms, NhomKNInfo info)
        {
            ...
            parms[1].Value = info.SoLuong;
            parms[2].Value = info.TenCQ;
            parms[3].Value = info.LoaiDoiTuongKNID;
            parms[4].Value = info.DiaChiCQ;
            parms[5].Value = info.DaiDienPhapLy;
            parms[6].Value = info.DuocUyQuyen;
