...
{
    /// <summary>
    /// Summary description for CountKeHoachTTCanDuyet
    /// </summary>
    public class CountKeHoachTTCanDuyet : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (coQuanID != 0)
            {
                ...
                try
                {
                    ...
                    countNotity = notify.Count_KeHoachTTCanDuyet(coQuanID, roleID, phongBanID).ToString();
                }
                catch
                {
                }
