...
{
    /// <summary>
    /// Summary description for CountDuyetXL
    /// </summary>
    public class CountDuyetXL : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (userID != 0 && coQuanID != 0)
            {
                ...
                try
                {
                    ...
                    countNotity = notify.Count_DTCanDuyetXL(userID, coQuanID, roleID, phongBanID).ToString();
                }
                catch
                {
                }
