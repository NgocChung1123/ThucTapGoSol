                ...
                success: function (data) {
                    ...
                    if (json.length > 0) {
                        for (var i = 0; i < json.length; i++) {
                            ...
                            var hiddenGroup = "";
                            var chitietdonthu = "onclick='ShowChiTietDonThuTraCuu(" + json[i].DonThuID + "," + json[i].XuLyDonID + ", 1, true," + json[i].NhomKNID + "," + json[i].DoiTuongBiKNID + "); return false;'";
