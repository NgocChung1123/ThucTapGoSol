<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="QLVanBanTraLoi.aspx.cs" Inherits="Com.Gosol.CMS.Web.Webapp.Backend.DonThu.QLVanBanTraLoi" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (json != null) {
                        ...
                        $('#MainContent_txtNgayXuLy').datepicker('setDate', json.NgayXuLyStr);
                        $('#MainContent_txtNgayBanHanh').datepicker('setDate', json.NgayBanHanh);
                        $('#MainContent_ddlCoQuanXuLy').val(json.CoQuanXuLyID).change();
                        $('#MainContent_ddlHuongXuLy').val(json.HuongXuLyID).trigger("change");
        ...
        function ResetForm() {
            ...
            $('#MainContent_txtTenQuyetDinh').val('');
        ...
        function sync() {
            ...
            //var url = 'http://localhost:49373/api/GetPortalSyncVanBanTraLoi';
            var url = '<%= System.Configuration.ConfigurationManager.AppSettings["APIUrl_GetPortalSyncVanBanTraLoi"].ToString() %>';
            $.ajax({
                url: url,
                type: "GET",
                success: function (data) {
                    if (data != null && data != "") {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            if (data[i].TrangThaiDonID != 2) {
                                ...
                                var fileUrl = "";
                                var tenFile = "";
                                for (var j = 0; j < data[i].lsFileYKienXuLy.length; j++) {
                                    fileUrl += data[i].lsFileYKienXuLy[j].FileBase64+','+ data[i].lsFileYKienXuLy[j].TenFile+','+ data[i].lsFileYKienXuLy[j].FileURL+ "*";
                                }
        ...
        function CapNhatKNTC() {
            //var url = '<%= System.Configuration.ConfigurationManager.AppSettings["APIUrl_GetPortalSyncVanBanTraLoi"].ToString() %>';
            //var url2 = "http://192.168.100.42:10008/api/GetPortalSync";
            $.ajax({
                url: url,
                type: "GET",
                success: function (data) {
        ...
        function ShowFileVBGQForm(DonThuID) {
            ...
            $.ajax({
                type: "POST",
                url: "QLVanBanTraLoi.aspx/GetFile",
                data: '{id:"' + DonThuID + '"}',
                dataType: "json",
                async: true,
                contentType: "application/json; charset=utf-8",
        ...
        function saveDB() {
            ...
            var dsFileName = [];
            var dataDonThu = "";
            for (var i = 0; i < listRow.length - 1; i++) {
            ...
            var demFile = 0;
            //console.log('so luong Save file', dsFileBase64.length);
            //for (var idxFile = 0; idxFile < dsFileBase64.length; idxFile++) {
            //    $.ajax({
            //        type: "POST",
            //        url: "QLVanBanTraLoi.aspx/SaveFileBase64",
            ...
            //    $("#hdfSaveFileDB").val(1);
            //    console.log('khong có file save', dsFileBase64.length);
            //    CheckKetThucDongBo();
            //}

            $.ajax({
                type: "POST",
                url: "QLVanBanTraLoi.aspx/SaveDB",
        ...
        function CheckKetThucDongBo() {
            ...
            console.log('CheckKetThucDongBo', dongBo, saveFile);
            if (dongBo == saveFile) {
                $("#hdfSaveFileDB").val(0);
                $("#hdfDongBoDB").val(2);
                window.location.reload(false);
        ...
        function ChangedIsShow(el) {
            ...
            $.ajax({
                type: "POST",
                url: "QLVanBanTraLoi.aspx/ChangedIsShow",
                                    ...
                                    <div class="box-header" style="padding: 0px; margin-bottom: 10px">
                                        ...
                                        <div class="col-lg-offset-9 col-lg-3 text-right" style="padding-right: 0px;">
                                            ...
                                            <span id="btnAction" style="display: none;">
                                                <asp:Button ID="btnEdit" CssClass="btn btn-primary" runat="server" Text="Sửa" OnClientClick="ShowEditForm();return false;" />
                                                <%--<input type="button" class="btn btn-primary" value="Sửa" onclick="ShowEditForm();" />--%>
                                                <asp:Button ID="btnDelete1" CssClass="btn btn-primary" runat="server" Text="Xóa" OnClientClick="ConfirmDelete();return false;" />
                                    ...
                                    <table id="example2" class="table table-bordered table-hover table-responsive">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 5%">Ngày tiếp nhận</th>
                                                <th style="width: 10%">CQ tiếp nhận</th>
                                                <th style="width: 10%">Hướng xử lý</th>
                                                <th style="width: 10%">Ngày ban hành QĐ</th>
                                                <th style="width: 5%">File đính kèm</th>
                                                <th style="width: 5%">Hiển thị</th>
                                            </tr>
                                        </thead>
                                        <tbody>

                                            <asp:Repeater ID="rptVanBan" runat="server" OnItemDataBound="rptVanBan_ItemDataBound" OnItemCommand="rptVanBan_ItemCommand">
                                                <ItemTemplate>
                                                    <tr onclick='<%# "removeDotDot("+ Eval("ID") +");"  %>'>
                                                        ...
                                                        <td class="dotdot" id='tdNoiDung<%# Eval("ID") %>' style="text-align: left">
                                                            <%# Eval("NoiDungDon") %>
                                                        ...
                                                        <td style="text-align: center">
                                                            <asp:CheckBox runat="server" value='<%# Eval("ID") %>' Style="display: none" ID="cbCongKhai" />
                                        ...
                                        <div class="divInsert">
                                            ...
                                            <div class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <asp:TextBox runat="server" ID="txtNgayXuLy" CssClass="form-control datepicker validate[custom[date]]"></asp:TextBox>
                                                    </div>
                                                     <label class="control-label col-md-2">
                                                        Cơ quan giải quyết
                                                    </label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <asp:DropDownList runat="server" ID="ddlHuongXuLy" CssClass="select2 form-control" DataValueField="HuongXuLyID" DataTextField="TenHuongXuLy" Style="width: 100%"></asp:DropDownList>
                                                    </div>
                                                    <label class="control-label col-md-2">
                                                        Cơ quan xử lý
                                                    </label>
                            ...
                            <div id="dongbo" class="tab-pane fade" style="padding-top: 5px">
                                ...
                                <div>
                                    <div id="tmplDonThuRow" style="display: none">
                                        ...
                                        <table id="tmplCTDTDB" class="table table-responsive" style="display: none">
                                            <tr>
                                                <td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">File đính kèm</h4>
                </div>
                <div class="modal-body">
                    <div class="box-body">
