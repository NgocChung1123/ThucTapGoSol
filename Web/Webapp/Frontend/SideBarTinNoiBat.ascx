<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SideBarTinNoiBat.ascx.cs" Inherits="Com.Gosol.CMS.Web.Webapp.Frontend.SideBar" %>
...
<div class="panel panel-primary" style="display: none;">
    ...
    <%--<asp:Button ID="btnLichTiepDan" runat="server" PostBackUrl="/Webapp/Frontend/LichTiepDan.aspx" CssClass="btn btn-lg btn-block btn-primary" Text="LỊCH TIẾP CÔNG DÂN" />
...
<div id="Sidebar_TinTuc" style="display: none">
    <div class="box box-primary">
        <div class="box-header" style="text-align: center">
            <i class="fc fc-grid"></i>
            <h1 class="box-title">TIN TỨC NỔI BẬT</h1>
        </div>
        <div class="box-body">
            <asp:Repeater ID="rptTinNoiBat" runat="server" OnItemDataBound="rptTinNoiBat_ItemDataBound">
                <ItemTemplate>
                    <div class="item-tin-noi-bat" style="width: 100%">
                        ...
                        <div class="item-tin-noi-bat-children item-tin-noi-bat-children-text" style="width: 100%">
