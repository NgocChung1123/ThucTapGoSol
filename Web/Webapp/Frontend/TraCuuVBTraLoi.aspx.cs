...
{
    public partial class TraCuuVBTraLoi : System.Web.UI.Page
    {
        private int stt = 1;
        ...
        public static string GetFile(string id)
        {
            ...
            try
            {
                listFileInfo = new DonThu().GetListFileYKienXuLyByID(DonThuID);
            }
            catch
            {
            }
        ...
        private void createPaging()
        {
            ...
            try
            {
                ...
                totalRow = new DAL.DonThu.DonThu().CountSearchDonThuByType(coQuanID, coQuanID2, SoDonThu, TenQuyetDinh, FromDate, ToDate,1);
            }
            catch
            {
        ...
        protected void BindRepeater()
        {
            ...
            try
            {
                ...
                list = new DAL.DonThu.DonThu().SearchDonThuByType( coQuanID,coQuanID2, SoDonThu, TenQuyetDinh, From, To, start, end,1);
        ...
        //protected void drdCoQuan_SelectedIndexChanged(object sender, EventArgs e)
        //{
        //    int coQuanID = Utils.ConvertToInt32(drdCoQuan.SelectedItem.Value, 0);

        //    Session["CoQuanID" + Request.Url.AbsolutePath] = coQuanID;
        //    BindCoQuan2(coQuanID);
        //    BindRepeater();
        //}
        ...
        //    parentList = (List<CoQuanInfo>)new DAL.CoQuan().GetCoQuanByParentID(1);
        //    drdCoQuan.DataSource = parentList;
        //    drdCoQuan.DataBind();
        //    drdCoQuan.Items.Insert(0, new ListItem("Chọn cơ quan", "0"));
        //    drdCoQuan.SelectedIndex = 0;


        //}
        //private void BindCoQuan2(int IDParent)
        //{
        //    List<CoQuanInfo> parentList = new List<CoQuanInfo>();

        //    parentList = (List<CoQuanInfo>)new DAL.CoQuan().GetCoQuanByParentID(IDParent);
        //    if(parentList.Count > 0)
        //    {
                
        //    }
        //    drdCoQuan2.DataSource = parentList;
        //    drdCoQuan2.DataBind();
        //    drdCoQuan2.Items.Insert(0, new ListItem("Chọn cơ quan", "0"));
        //    drdCoQuan2.SelectedIndex = 0;
        //}
        protected void rptDonThu_ItemDataBound1(object sender, RepeaterItemEventArgs e)
        {
        ...
        [WebMethod]
        public static List<CoQuanInfo> GetListCoQuanByParentID(int ParentID)
        {
            List<CoQuanInfo> parentList = new List<CoQuanInfo>();

            parentList = (List<CoQuanInfo>)new DAL.CoQuan().GetCoQuanByParentID(ParentID);
            return parentList;
        }
