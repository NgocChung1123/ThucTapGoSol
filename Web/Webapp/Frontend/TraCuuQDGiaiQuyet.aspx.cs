...
{
    public partial class TraCuuQDGiaiQuyet : System.Web.UI.Page
    {
        private int stt = 1;
        ...
        private void createPaging()
        {
            ...
            try
            {
                ...
                totalRow = new DAL.DonThu.DonThu().CountSearchDonThuByType(coQuanID, coQuanID2, SoDonThu, TenQuyetDinh, FromDate, ToDate, 2);
            }
            catch
            {
        ...
        protected void BindRepeater()
        {
            ...
            try
            {
                ...
                list = new DAL.DonThu.DonThu().SearchDonThuByType(coQuanID, coQuanID2, SoDonThu, TenQuyetDinh, From, To, start, end, 2);
        ...
        public static string GetFile(string id)
        {
            ...
            try
            {
                listFileInfo = new DonThu().GetListFileKetQuaByID(DonThuID);
            }
            catch
            {
            }
