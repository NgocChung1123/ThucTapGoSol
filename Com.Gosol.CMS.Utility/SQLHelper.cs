...
namespace Com.Gosol.CMS.Utility
{
	...
	public class SQLHelper
	{
        ...
        //public static readonly string CONN_BACKEND = @"Data Source=TRANHOAT-PC\SQLEXPRESS;Initial Catalog=KetoanCDT;Persist Security Info=True;User ID=sa;Password=123456";
        ...
        //public static readonly string CONN_BACKEND = @"Data Source=PC01\SQLEXPRESS;Initial Catalog=KetoanCDT;Integrated Security=True";
        //public static readonly string CONN_BACKEND = @"Data Source=.;Initial Catalog=KetoanCDT;Integrated Security=True";
		//public static readonly string CONN_FRONTEND = ConfigurationSettings.AppSettings["FrontendDB"];
		//public static readonly string CONN_QUEUE = ConfigurationSettings.AppSettings["QueueDB"];
		//public static readonly string CONN_XML = ConfigurationSettings.AppSettings["XML"];
        
        //public static readonly bool WORKFLOW =ConfigurationSettings.AppSettings["WORKFLOW"]!=null ? bool.Parse(ConfigurationSettings.AppSettings["WORKFLOW"]):false ; 
