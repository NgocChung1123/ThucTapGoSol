namespace Com.Gosol.CMS.Security
{
    ...
    internal sealed class AccessControlData
    {
        ...
        private static string SELECT_USER_INFO = "Select a.*, b.TenCanBo, b.PhongBanID, c.TenCoQuan, c.CoQuanID, c.CoQuanChaID, c.CapID, c.TinhID, c.HuyenID, c.XaID, c.MaCQ, d.TenTinh, c.SuDungPM, b.RoleID, e.RoleName, c.WorkFlowID, f.WorkFlowCode, c.WFTienHanhTTID, g.WorkFlowCode as WFCodeTienHanhTT From [NguoiDung] a join DM_CanBo b on a.CanBoID = b.CanBoID left join DM_CoQuan c on b.CoQuanID = c.CoQuanID left join DM_Tinh d on c.TinhID = d.TinhID left join Role e on b.RoleID = e.RoleID left join WorkFlow f on c.WorkFlowID = f.WorkFlowID left join WorkFlow g on c.WFTienHanhTTID = g.WorkFlowID Where (NguoiDungID=@NguoiDungID)";
