...
namespace Com.Gosol.CMS.Model
{
    public class BaoCao2dInfo
    {
        ...
        public decimal Col11Data { get; set; }
        public int Col12Data { get; set; }
        public decimal Col13Data { get; set; }
        ...
        public decimal Col26Data { get; set; }
        public int Col27Data { get; set; }
        public decimal Col28Data { get; set; }
        public int Col29Data { get; set; }
        public decimal Col30Data { get; set; }
        public int Col31Data { get; set; }
        public decimal Col32Data { get; set; }
